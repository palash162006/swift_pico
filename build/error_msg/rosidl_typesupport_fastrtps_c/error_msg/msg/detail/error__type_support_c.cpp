...
#include "error_msg/msg/detail/error__rosidl_typesupport_fastrtps_c.h"
...
#include "error_msg/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Error__ros_msg_type = error_msg__msg__Error;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_error_msg
size_t get_serialized_size_error_msg__msg__Error(
  const void * untyped_ros_message,
...
static uint32_t _Error__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_error_msg__msg__Error(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_error_msg
size_t max_serialized_size_error_msg__msg__Error(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = error_msg__msg__Error;
    is_plain =
      (
...
static size_t _Error__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_error_msg__msg__Error(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, error_msg, msg, Error)() {
