...
static const _Error_type_support_symbol_names_t _Error_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, error_msg, msg, Error)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, error_msg, msg, Error)),
  }
};
...
{
  return &::error_msg::msg::rosidl_typesupport_cpp::Error_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, error_msg, msg, Error)() {
  return get_message_type_support_handle<error_msg::msg::Error>();
}
