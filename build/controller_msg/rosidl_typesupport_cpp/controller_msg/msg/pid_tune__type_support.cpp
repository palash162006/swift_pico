...
static const _PIDTune_type_support_symbol_names_t _PIDTune_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, controller_msg, msg, PIDTune)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, controller_msg, msg, PIDTune)),
  }
};
...
{
  return &::controller_msg::msg::rosidl_typesupport_cpp::PIDTune_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, controller_msg, msg, PIDTune)() {
  return get_message_type_support_handle<controller_msg::msg::PIDTune>();
}
