...
bool controller_msg__msg__pid_tune__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("controller_msg.msg._pid_tune.PIDTune", full_classname_dest, 36) == 0);
  }
  controller_msg__msg__PIDTune * ros_message = _ros_message;
  {  // kp
...
PyObject * controller_msg__msg__pid_tune__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("controller_msg.msg._pid_tune");
